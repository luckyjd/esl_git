...
if (!class_exists('THIM_Meta_Box')) {
	...
	class THIM_Meta_Box
	{
		...
		{
			wp_enqueue_style('thim-meta-box', CORE_PLUGIN_URL . '/lib/meta-boxes/css/meta-box.css', array(), "");
		}
...
//			wp_enqueue_script('jquery-ui', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.10.4/jquery-ui.min.js', array('jquery'));
			...
			wp_enqueue_style('thim-image-video', CORE_PLUGIN_URL . '/lib/meta-boxes/css/image-video.css', array(), "");
			wp_enqueue_script('thim-image-video-js', CORE_PLUGIN_URL . '/lib/meta-boxes/js/image-video.js', array('jquery-ui-sortable'), "", true);
