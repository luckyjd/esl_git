		...
		<?php else : ?>
			...
			<?php if ( $can_update ) : ?>
                <div class="update-message notice inline notice-warning notice-alt">
                    <p><a href="<?php echo esc_url( $data['url'] ); ?>" target="_blank"><?php printf( __( 'View version %1$s details.', 'thim-core' ), $data['version'] ); ?></a>
						<?php if ( $is_active ) : ?>
...
<div class="tc-box-footer">
	...
	?>
    <a class="button button-secondary tc-button" href="<?php echo esc_url( $link_check ); ?>"><?php esc_html_e( 'Check again', 'thim-core' ); ?></a>
</div>
