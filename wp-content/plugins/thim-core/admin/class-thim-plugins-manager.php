...
class Thim_Plugins_Manager extends Thim_Admin_Sub_Page {
	...
	public static function get_link_download_plugin( $slug ) {
		...
		$url      = sprintf( '%s/download-plugin/?plugin=%s&code=%s',
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'thim-plugins-manager', THIM_CORE_ADMIN_URI . '/assets/js/plugins/plugins-manager.js', array( 'thim-plugins', 'thim-isotope', 'updates', 'thim-core-admin' ), THIM_CORE_VERSION );
	}
