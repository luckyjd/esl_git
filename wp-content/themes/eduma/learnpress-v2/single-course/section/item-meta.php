...
<div class="course-item-meta">
	...
	<?php if ( $item_preview ): ?>
		<a title="<?php esc_html_e( 'Previews', 'eduma' ); ?>" class="lesson-preview button-load-item" href="<?php echo $course->get_item_link( $item->ID ); ?>" data-id="<?php echo $item->ID; ?>" data-complete-nonce="<?php echo wp_create_nonce( 'learn-press-complete-' . $item->post_type . '-' . $item->ID ); ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
	<?php endif; ?>
	<?php
