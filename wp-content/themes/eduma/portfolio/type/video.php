	...
	<div class="row entry-content-portfolio">
		<div class="entry-content-left col-sm-12">
			...
			if ( get_post_meta( get_the_ID(), 'project_video_embed', true ) ) {
				echo '<iframe title="YouTube video player" class="youtube-video" allowfullscreen type="text/html" width="100%" height="500" src="http://www.youtube.com/embed/' . get_post_meta( get_the_ID(), 'project_video_embed', true ) . '" frameborder="0"></iframe>';
